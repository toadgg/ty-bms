        ...
        <div class="box box-primary">
            <div class="box-header no-padding">
                ...
                <div class="box-tools pull-right">
                    <a href="{{ route('receipts.index', [ 'y' => $year - 1]) }}" class="btn btn-box-tool " data-toggle="tooltip" title="" data-original-title="{{ $year - 1 }}年"><i class="fa fa-chevron-left">{{ $year - 1 }}年</i></a>
                    <a href="{{ route('receipts.index', [ 'y' => $year + 1]) }}" class="btn btn-box-tool @if($year - date('Y') == 0) disabled @endif" data-toggle="tooltip" title="" data-original-title="{{ $year + 1 }}年"><i class="fa">{{ $year + 1 }}年</i><i class="fa fa-chevron-right"></i></a>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var table = $('#tyTable').DataTable({
                ...
                ajax: "{{ route('receipts.index', ['y' => $year]) }}",
                fixedColumns: {
                    leftColumns: 2,
                    rightColumns: 1
                },
